...
const styles = StyleSheet.create({
  ...
  topCenterContainer: { position: 'absolute', width: '100%', zIndex: 50 },
  ...
  hudPill: { flexDirection: 'row', backgroundColor: 'rgba(0,0,0,0.8)', paddingVertical: 12, paddingLeft: 20, paddingRight: 5, borderRadius: 25, alignItems: 'center', borderWidth: 1, borderColor: '#4da6ff' },
  hudText: { color: '#fff', fontSize: 14, fontWeight: 'bold' },

  overlay: { position: 'absolute', bottom: 0, width: '100%', backgroundColor: 'transparent', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', paddingHorizontal: 40 },
